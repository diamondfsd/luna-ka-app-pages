...
const TRANSLATIONS = {
  ...
  en: {
    ...
    navSupport: 'Support',
    heroEyebrow: 'LUNA CAMERA APP',
    heroLead: 'Gimbal control, directing, and creative production',
    heroSummary:
    ...
    footerLine: 'Gimbal camera control, directing, and creative production.',
