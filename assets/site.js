...
const TRANSLATIONS = {
  zh: {
    ...
    downloadLead:
      'Android 可在此下载正式版 APK。iOS 与 HarmonyOS 将沿用各自平台的分发方式。',
  ...
  en: {
    ...
    navSupport: 'Support',
    heroEyebrow: 'LUNA CAMERA APP',
    heroLead: 'Connect, control, and create from one phone.',
    heroSummary:
    ...
    downloadLead:
      'Download the release APK for Android. iOS and HarmonyOS use their native distribution channels.',
    ...
    footerLine: 'Camera control and creative workflows for gimbal cameras.',
